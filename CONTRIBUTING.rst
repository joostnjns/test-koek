...
Report bugs at https://github.com/joostnjns/test-koek/issues
...
https://github.com/joostnjns/test-koek/issues.
...
Ready to contribute? Here's how to set up `test-koek` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `test-koek` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/test-koek.git
